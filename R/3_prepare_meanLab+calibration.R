...
# COLLECT raw DATA 
  d = fread( here('//ds/raw_data_kemp/FIELD/Barrow/REPH_BODY_PICTURES/RGB.csv') )
...
# subset data bigger 255
dn = d[R > 255, .(path)] %>% unique()
# d = d[R < 255]
...
# EXPORT
  # fwrite(m, here('//ds/raw_data_kemp/FIELD/Barrow/REPH_BODY_PICTURES/Lab_means.csv')   )
  fwrite(m, here('//ds/raw_data_kemp/FIELD/Barrow/REPH_BODY_PICTURES/Lab_means_set255.csv')   )
  
  fwrite(dn, '//ds/raw_data_kemp/FIELD/Barrow/REPH_BODY_PICTURES/R_bigger_255.csv')
